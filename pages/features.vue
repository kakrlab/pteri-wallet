<template>
    <div>
        <section class="py-12">
            <div class="md:block container px-4 mx-auto md:w-4/6">
                <ul class="flex justify-center -mx-4 -mb-16">
                    <li>
                        <a href="#send" class="w-1/2 md:w-1/3 xl:w-1/6 px-4 mb-8 border-r border-gray-400 text-center text-gray-900  dark:text-gray-100"
                            @click.prevent="activeTab = 'send'" :class="{ active: activeTab === 'send' }">Send</a>
                        <!-- <img class="block mx-auto" src="wrexa-assets/logos/brands/docusign-gray.svg" alt=""> -->
                    </li>
                    <li>
                        <a href="#recieve"
                            class="w-1/2 md:w-1/3 xl:w-1/6 px-4 mb-8 border-r border-gray-400 text-center text-gray-900  dark:text-gray-100"
                            @click.prevent="activeTab = 'recieve'"
                            :class="{ active: activeTab === 'recieve' }">Recieve</a>
                        <!-- <img class="block mx-auto" src="wrexa-assets/logos/brands/british-business-bank-gray.svg" alt=""> -->
                    </li>
                    <li>
                        <a href="#tokens" class="w-1/2 md:w-1/3 xl:w-1/6 px-4 mb-8 border-r border-gray-400 text-center text-gray-900  dark:text-gray-100"
                            @click.prevent="activeTab = 'tokens'" :class="{ active: activeTab === 'tokens' }">Token</a>
                        <!-- <img class="block mx-auto" src="wrexa-assets/logos/brands/fedex-gray.svg" alt=""> -->
                    </li>
                    <li>
                        <a href="#sdas" class="w-1/2 md:w-1/3 xl:w-1/6 px-4 mb-8 border-r border-gray-400 text-center text-gray-900  dark:text-gray-100"
                            @click.prevent="activeTab = 'sdas'" :class="{ active: activeTab === 'sdas' }">SDAs</a>
                        <!-- <img class="block mx-auto" src="wrexa-assets/logos/brands/starlingbank-gray.svg" alt=""> -->
                    </li>
                    <li>
                        <a href="#security" class="w-1/2 md:w-1/3 xl:w-1/6 px-4 mb-8 text-center text-gray-900  dark:text-gray-100"
                            @click.prevent="activeTab = 'security'"
                            :class="{ active: activeTab === 'security' }">Security</a>
                        <!-- <img class="block mx-auto" src="wrexa-assets/logos/brands/zendesk-gray.svg" alt=""> -->
                    </li>
                    <!-- <div class="w-1/2 md:w-1/3 xl:w-1/6 px-4 mb-8">
                        <img class="block mx-auto" src="wrexa-assets/logos/brands/docusign-gray.svg" alt="">
                    </div> -->
                </ul>
            </div>
        </section>
        <section class="relative py-14 mx-5 md:mx-20 xl:pb-32 overflow-hidden text-gray-900  dark:text-gray-100" id="#send" v-show="activeTab === 'send'">
            <!-- <img class="absolute top-0 left-1/2 transform -translate-x-1/2 ml-24" src="saturn-assets/images/headers/center-orange-light.png" alt=""> -->
            <!-- <img class="absolute bottom-0 left-0" src="saturn-assets/images/headers/blue-light-left-bottom.png" alt=""> -->
            <!-- <img class="absolute top-0 right-0 w-52 md:w-auto" src="saturn-assets/images/headers/star-background-header.png" alt=""> -->
            <!-- <img class="hidden sm:block lg:hidden absolute top-1/2 w-64 sm:w-auto right-0 -mt-20 mr-5" src="saturn-assets/images/headers/small-image.png" alt=""> -->
            <div class="relative container px-4 mx-0 md:mx-auto">
                <div class="mb-8 lg:mb-12 px-10" >
                    <!-- <span
                        class="inline-block py-2 px-5 mb-2 font-semibold text-black bg-purple-100 rounded-full">Securing
                        your assets one address at a time!</span> -->
                    <div class="relative hand flex justify-between items-center">
                        <div>
                            <h1
                                class="font-heading text-2xl xs:text-3xl md:text-4xl xl:text-6xl font-bold text-gray-900 dark:text-gray-100 sm:mb-6">
                                <span>Send assets <br>seamlessly <br></span>
                                <!-- <span class="font-serif italic">custody</span> -->
                            </h1>
                            <p class="text-lg">Send assets directly from Cyto Wallet mobile <br> app and browser
                                extensions.</p>
                        </div>
                        <div class="flex justify-center items-center">
                            <img class="hidden lg:block -mb-6 h-80 w-80 transform" src="~/assets/sendphone.png" alt="">
                        </div>
                    </div>
                    <div class="lg:flex items-center">
                        ...
                        <div class="mb-8 lg:mb-0 lg:mr-8">
                            <a class="relative group inline-block w-full sm:w-auto py-4 px-8 text-black font-semibold bg-purple-500 rounded-md overflow-hidden hover:text-purple-500"
                                href="#">
                                <div
                                    class="absolute top-0 right-full w-full h-full bg-black text-purple-500 transform group-hover:translate-x-full group-hover:scale-102 transition duration-500">
                                </div>
          ...
          <img class="w-10 h-10 -ml-2" src="saturn-assets/images/headers/avatar1.png" alt="">
                            <div class="p-px bg-white dark:bg-black rounded-full -ml-2">
            ...
            <div class="hidden navbar-menu fixed top-0 left-0 bottom-0 w-5/6 max-w-md z-50">
                ...
                <nav class="relative flex flex-col py-6 px-10 w-full h-full bg-white dark:bg-black border-r overflow-y-auto">
                    ...
                    <div>
                        <ul class="mb-2">
                            <li><a class="block py-4 px-5 text-gray-900  dark:text-gray-100 hover:bg-orange-50 rounded-lg" href="#">About
                                    Us</a></li>
                            <li><a class="block py-4 px-5 text-gray-900  dark:text-gray-100 hover:bg-orange-50 rounded-lg"
                                    href="#">Featured</a></li>
                            <li><a class="block py-4 px-5 text-gray-900  dark:text-gray-100 hover:bg-orange-50 rounded-lg"
                                    href="#">Solutions</a></li>
                            <li><a class="block py-4 px-5 text-gray-900  dark:text-gray-100 hover:bg-orange-50 rounded-lg"
                        ...
                        <!-- <div class="py-8 px-6 mb-6 border-t border-b border-gray-200">
                            <a class="flex items-center text-sm font-semibold text-orange-900 hover:text-orange-600"
                                href="#">
                        ...
                        <div class="flex px-6 mb-16 items-center"><a
                                class="inline-block mr-9 text-sm font-semibold text-orange-900 hover:text-gray-900  dark:text-gray-100"
                                href="#">Sign In</a><a
        ...
        <section class="relative py-14 mx-5 md:mx-20 xl:pb-32 overflow-hidden text-gray-900  dark:text-gray-100" id="#recieve"
            v-show="activeTab === 'recieve'">
            <div class="relative container px-4 mx-0 md:mx-auto">
                <div class="mb-8 lg:mb-12 ">
                    ...
                    <div class="relative hand flex justify-between items-center">
                        <div>
                            <h1
                                class="font-heading text-2xl xs:text-3xl md:text-4xl xl:text-6xl font-bold text-gray-900  dark:text-gray-100 sm:mb-6">
                                <span>Recieve assets <br>with ease<br></span>
                                <!-- <span class="font-serif italic">custody</span> -->
                            </h1>
                            <p class="text-lg">Recieve assets directly into Cyto Wallet mobile <br> app and browser
                                extensions by QRCode or sharing your addresses</p>
                        </div>
                        <div class="flex justify-center items-center">
                            <img class="hidden lg:block -mb-6 h-80 w-80 transform" src="~/assets/recievephone.png"
                                alt="">
                        </div>
                    </div>
                    <div class="lg:flex items-center">
        ...
        <section class="relative py-14 mx-5 md:mx-20 xl:pb-32 overflow-hidden text-gray-900  dark:text-gray-100" id="#tokens"
                ...
                <div class="mb-8 lg:mb-12 ">
                    ...
                    <div class="relative hand flex justify-between items-center">
                        <div>
                            <h1
                                class="font-heading text-2xl xs:text-3xl md:text-4xl xl:text-6xl font-bold text-gray-900  dark:text-gray-100 sm:mb-6">
                                <span>Manage <br>Token Assets <br></span>
                                <!-- <span class="font-serif italic">custody</span> -->
                            </h1>
                            <p class="text-lg">Manage Token created on the Omnilite Network</p>
                        </div>
                        <div class="flex justify-center items-center">
                            <img class="hidden lg:block -mb-6 h-80 w-96 transform" src="~/assets/tokens.png" alt="">
                        </div>
                    </div>
                    <div class="lg:flex items-center">
                        <!-- <div class="mb-10 lg:mb-0 lg:mr-10">
        ...
        <section class="relative py-14 mx-5 md:mx-20 xl:pb-32 overflow-hidden text-gray-900  dark:text-gray-100" id="#sdas" v-show="activeTab === 'sdas'">
            <!-- <img class="absolute top-0 left-1/2 transform -translate-x-1/2 ml-24" src="saturn-assets/images/headers/center-orange-light.png" alt=""> -->
            <!-- <img class="absolute bottom-0 left-0" src="saturn-assets/images/headers/blue-light-left-bottom.png" alt=""> -->
            <!-- <img class="absolute top-0 right-0 w-52 md:w-auto" src="saturn-assets/images/headers/star-background-header.png" alt=""> -->
            <!-- <img class="hidden sm:block lg:hidden absolute top-1/2 w-64 sm:w-auto right-0 -mt-20 mr-5" src="saturn-assets/images/headers/small-image.png" alt=""> -->
                ...
                <div class="mb-8 lg:mb-12 ">
                    ...
                    <div class="relative hand flex justify-between items-center">
                        <div>
                            <h1
                                class="font-heading text-2xl xs:text-3xl md:text-4xl xl:text-6xl font-bold text-gray-900  dark:text-gray-100 sm:mb-6">
                                <span>Manage SDAs <br>seamlessly <br></span>
                                <!-- <span class="font-serif italic">custody</span> -->
                            </h1>
                            <p class="text-lg">Manage Secure Digital Assets (SDA) common know as NFTs <br> directly from
                                Cyto Wallet mobile app and browser extensions.</p>
                        </div>
                        <div class="flex justify-center items-center">
                            <img class="hidden lg:block -mb-6 h-80 w-80 transform" src="~/assets/desktop.png" alt="">
                        </div>
                    </div>
                    <div class="lg:flex items-center">
                        <!-- <div class="mb-10 lg:mb-0 lg:mr-10">
            ...
            <div class="border rounded-lg p-10 bg-purple-100">

                <h2 class="text-xl lg:text-2xl font-bold mb-6 text-gray-700">Sending NFTs via OmniLite</h2>
                <p class="text-gray-700 font-medium text-lg mb-6">
                    <span>1.</span>
                    <span>Select Your NFT: In the NFT section of your wallet, choose the NFT you wish to send.</span>
                </p>
                <p class="text-gray-700 font-medium text-lg mb-6">
                    <span>2. Recipient's OmniLite Address: Input the recipient's OmniLite address accurately.</span>
                </p>
                <p class="text-gray-700 font-medium text-lg mb-8">
                    <span>3.</span>
                    Confirm and Send: After verifying transaction details, including sufficient LTC for fees, send
                    your NFT.
                </p>
                <!-- <h2 class="text-xl lg:text-4xl font-bold mb-6">Managing Your Assets</h2>
                <p class="text-gray-700 font-medium text-lg mb-8">
                    <span>Receiving and Sending Cryptocurrency</span>
                    <span>Receive Crypto: Navigate to the 'Receive' section, select the desired cryptocurrency, and
                        share your public address or QR code with the sender.</span>
                    <br>
                    <br>
                    <span>Receiving and Sending Cryptocurrency</span>
                    <span>Throughout the process, we prioritized data privacy and security. We implemented robust
                        encryption protocols and strict access controls to ensure that sensitive user information
                        remains protected at all times. Building trust with our users has been of utmost importance,
                        and we are committed to maintaining a secure environment for their valuable assets.</span>
                </p> -->
            </div>
            <!-- <div class="hidden navbar-menu fixed top-0 left-0 bottom-0 w-5/6 max-w-md z-50">
                <div class="navbar-backdrop fixed inset-0 bg-gray-800 opacity-25"></div>
        ...
        <section class="relative py-14 mx-5 md:mx-20 xl:pb-32 overflow-hidden text-gray-900  dark:text-gray-100" id="#security"
                ...
                <div class="mb-8 lg:mb-12  px-10">
                    ...
                    <div class="relative hand flex justify-between items-center">
                        <div>
                            <h1
                                class="font-heading text-2xl xs:text-3xl md:text-4xl xl:text-6xl font-bold text-gray-900  dark:text-gray-100 sm:mb-6">
                                <span>Security <br>Assured <br></span>
                                <!-- <span class="font-serif italic">custody</span> -->
                            </h1>
                            <p class="text-lg">Built on algorithms developed <br> for the security of your digital
                                Assets </p>
                        </div>
                        <div class="flex justify-center items-center">
                            <img class="hidden lg:block -mb-6 h-80 w-80 transform" src="~/assets/robot-hand-header.png"
                                alt="">
                        </div>
                    </div>
                    <div class="lg:flex items-center">
